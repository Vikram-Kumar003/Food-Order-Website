...
<div class="main-content">
    <div class="wrapper">
        ...
        <!-- add categor form start here  -->

        <form action="" method="POST" enctype="multipart/form-data">
            <!-- this allow to add upload something -->
            <table class = "tbl-30">
                <tr>
                    <td>Title: </td>
                    <td>
        ...
        <?php 
              ...
              if(isset($_POST['submit']))
              {
                ...
                // 4. check whether the query executed or not and data addded or not 

                if($res==true)
                {
                    // query executed and categroy added 
